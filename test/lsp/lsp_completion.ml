...
let%expect_test "division-and-section-completion" =
  ...
  [%expect {|
    ...
    ----           ^
       ...
       4           DATA DIVISION.
    (line 1, character 8):
    List of completions (1 entries): [CONTROL]
    ...
    (line 3, character 8):
    List of completions (23 entries): [AUTHOR;CONFIGURATION;DATA;DATE-COMPILED;DATE-MODIFIED;DATE-WRITTEN;END;ENVIRONMENT;FD;FILE;FILE-CONTROL;ID;IDENTIFICATION;INPUT-OUTPUT;INSTALLATION;I-O-CONTROL;OPTIONS;PROCEDURE;PROGRAM-ID;REMARKS;SD;SECURITY;SELECT]
    ...
    (line 4, character 8):
    List of completions (15 entries): [COMMUNICATION;DATA;END;FD;FILE;ID;IDENTIFICATION;LINKAGE;LOCAL-STORAGE;PROCEDURE;PROGRAM-ID;REPORT;SCREEN;SD;WORKING-STORAGE]
    ...
    ----           ^
       ...
       9             STOP RUN.
    (line 6, character 8):
    List of completions (11 entries): [COMMUNICATION;END;ID;IDENTIFICATION;LINKAGE;LOCAL-STORAGE;PROCEDURE;PROGRAM-ID;REPORT;SCREEN;WORKING-STORAGE]
...
let%expect_test "datadiv-completion" =
  ...
  [%expect {|
    ...
    (line 5, character 11):
    List of completions (70 entries): [ALIGNED;ANY;BASED;BINARY;BINARY-CHAR;BINARY-C-LONG;BINARY-DOUBLE;BINARY-LONG;BINARY-SHORT;BIT;BLANK;CLASS;COMP;COMP-0;COMP-1;COMP-10;COMP-15;COMP-2;COMP-3;COMP-4;COMP-5;COMP-6;COMP-9;COMP-N;COMP-X;DEFAULT;DESTINATION;DISPLAY;DYNAMIC;EXTERNAL;FILLER;FLOAT-BINARY-128;FLOAT-BINARY-32;FLOAT-BINARY-64;FLOAT-DECIMAL-16;FLOAT-DECIMAL-34;FLOAT-EXTENDED;FLOAT-LONG;FLOAT-SHORT;FUNCTION-POINTER;GLOBAL;GROUP-USAGE;INDEX;INVALID;IS EXTERNAL;IS GLOBAL;IS TYPEDEF;JUSTIFIED;NATIONAL;OBJECT;OCCURS;PACKED-DECIMAL;PICTURE;POINTER;PRESENT;PROCEDURE-POINTER;PROGRAM-POINTER;PROPERTY;REDEFINES;SAME;SELECT;SIGN;SYNCHRONIZED;TYPE;TYPEDEF;USAGE;VAL-STATUS;VALUE;VALUES;VARYING]
    ...
    ----                        ^
       ...
       8             88 BB VALUES ARE "x" THRU "Z".
    (line 5, character 21):
    List of completions (71 entries): [ALIGNED;ANY;BASED;BINARY;BINARY-CHAR;BINARY-C-LONG;BINARY-DOUBLE;BINARY-LONG;BINARY-SHORT;BIT;BLANK;CLASS;COMP;COMP-0;COMP-1;COMP-10;COMP-15;COMP-2;COMP-3;COMP-4;COMP-5;COMP-6;COMP-9;COMP-N;COMP-X;CONSTANT;DEFAULT;DESTINATION;DISPLAY;DYNAMIC;EXTERNAL;FLOAT-BINARY-128;FLOAT-BINARY-32;FLOAT-BINARY-64;FLOAT-DECIMAL-16;FLOAT-DECIMAL-34;FLOAT-EXTENDED;FLOAT-LONG;FLOAT-SHORT;FUNCTION-POINTER;GLOBAL;GROUP-USAGE;INDEX;INVALID;IS EXTERNAL;IS GLOBAL;IS TYPEDEF;JUSTIFIED;NATIONAL;OBJECT;OCCURS;PACKED-DECIMAL;PICTURE;POINTER;PRESENT;PROCEDURE-POINTER;PROGRAM-POINTER;PROPERTY;REDEFINES;RENAMES;SAME;SELECT;SIGN;SYNCHRONIZED;TYPE;TYPEDEF;USAGE;VAL-STATUS;VALUE;VALUES;VARYING]
    __rootdir__/prog.cob:7.8:
       4           DATA DIVISION.
       5           WORKING-STORAGE SECTION.
       6           01 DATA-NAME PIC X.
    ...
    ----                            ^
       ...
       9           PROCEDURE DIVISION.
    (line 6, character 25):
    List of completions (71 entries): [ALIGNED;ANY;BASED;BINARY;BINARY-CHAR;BINARY-C-LONG;BINARY-DOUBLE;BINARY-LONG;BINARY-SHORT;BIT;BLANK;CLASS;COMP;COMP-0;COMP-1;COMP-10;COMP-15;COMP-2;COMP-3;COMP-4;COMP-5;COMP-6;COMP-9;COMP-N;COMP-X;DEFAULT;DEPENDING;DESTINATION;DISPLAY;DYNAMIC;EXTERNAL;FLOAT-BINARY-128;FLOAT-BINARY-32;FLOAT-BINARY-64;FLOAT-DECIMAL-16;FLOAT-DECIMAL-34;FLOAT-EXTENDED;FLOAT-LONG;FLOAT-SHORT;FUNCTION-POINTER;GLOBAL;GROUP-USAGE;INDEX;INVALID;IS EXTERNAL;IS GLOBAL;IS TYPEDEF;JUSTIFIED;LOCALE;NATIONAL;OBJECT;OCCURS;PACKED-DECIMAL;PICTURE;POINTER;PRESENT;PROCEDURE-POINTER;PROGRAM-POINTER;PROPERTY;REDEFINES;SAME;SELECT;SIGN;SYNCHRONIZED;TYPE;TYPEDEF;USAGE;VAL-STATUS;VALUE;VALUES;VARYING]
    ...
    ----                                  ^
      ...
      10             DISPLAY DATA-NAME.
    (line 7, character 31):
    List of completions (9 entries): [ALL;HIGH-VALUES;IN;LOW-VALUES;QUOTES;SPACES;THRU;WHEN;ZEROS] |}]
...
let%expect_test "procedure-paragraph-completion" =
  ...
  [%expect {|
    ...
    ----               ^
      ...
      12               DISPLAY VAR.
    (line 9, character 12):
    List of completions (60 entries): [ACCEPT;ADD;ALLOCATE;ALTER;CALL;CANCEL;CLOSE;COMPUTE;CONTINUE;DELETE;DISABLE;DISPLAY;DIVIDE;ENABLE;END;ENTER;ENTRY;EVALUATE;EXIT;FREE;GENERATE;GO;GOBACK;ID;IDENTIFICATION;IF;INITIALIZE;INITIATE;INSPECT;INVOKE;MERGE;MOVE;MULTIPLY;NEXT SENTENCE;OPEN;PERFORM;PROGRAM-ID;PURGE;RAISE;READ;RECEIVE;RELEASE;RESUME;RETURN;REWRITE;SEARCH;SEND;SET;SORT;START;STOP;STRING;SUBTRACT;SUPPRESS;TERMINATE;TRANSFORM;UNLOCK;UNSTRING;VALIDATE;WRITE]
    ...
    List of completions (75 entries): [ACCEPT;ADD;ADDRESS;ALLOCATE;ALTER;CALL;CANCEL;CLOSE;COMPUTE;CONTINUE;DELETE;DISABLE;DISPLAY;DIVIDE;ENABLE;END-PERFORM;ENTER;ENTRY;EVALUATE;EXCEPTION-OBJECT;EXIT;FOREVER;FREE;FUNCTION;GENERATE;GO;GOBACK;IF;INITIALIZE;INITIATE;INSPECT;INVOKE;LINAGE-COUNTER;LINE-COUNTER;MERGE;MOVE;MULTIPLY;NEXT SENTENCE;NULL;OPEN;PAGE-COUNTER;PERFORM;PURGE;FIRST-SECTION;FIRST-PARAGRAPH;FIRST-PARAGRAPH IN FIRST-SECTION;SECOND-SECTION;DATA-NAME;VAR;RAISE;READ;RECEIVE;RELEASE;RESUME;RETURN;REWRITE;SEARCH;SELF;SEND;SET;SORT;START;STOP;STRING;SUBTRACT;SUPER;SUPPRESS;TERMINATE;TRANSFORM;UNLOCK;UNSTRING;VALIDATE;WITH;WRITE;ZEROS] |}]
...
let%expect_test "qualified-data-ref-completion" =
  ...
  [%expect {|
    ...
    List of completions (23 entries): [ADDRESS;ALL;EXCEPTION-OBJECT;FUNCTION;HIGH-VALUES;LINAGE-COUNTER;LINE-COUNTER;LOW-VALUES;NULL;PAGE-COUNTER;QUOTES;AA;CC;CC IN AA;DD;DD IN CC IN AA;BB;CC;CC IN BB;SELF;SPACES;SUPER;ZEROS] |}]
...
let%expect_test "procedure-completion" =
  ...
  [%expect {|
    ...
    ----                        ^
      ...
      11             MULTIPLY 4 BY 2 GIVING BB
    (line 8, character 21):
    List of completions (89 entries): [ACCEPT;ADD;ADDRESS;ALL;ALLOCATE;ALTER;AS;AT;CALL;CANCEL;CLOSE;COL;COLUMN;COMPUTE;CONTINUE;DELETE;DISABLE;DISPLAY;DIVIDE;ENABLE;END-DISPLAY;ENTER;ENTRY;EVALUATE;EXCEPTION;EXCEPTION-OBJECT;EXIT;FREE;FUNCTION;GENERATE;GO;GOBACK;HIGH-VALUES;IF;IN;INITIALIZE;INITIATE;INSPECT;INVOKE;LINAGE-COUNTER;LINE;LINE-COUNTER;LOW-VALUES;MERGE;MODE;MOVE;MULTIPLY;NEXT SENTENCE;NOT ON EXCEPTION;NULL;OF;ON EXCEPTION;OPEN;PAGE-COUNTER;PERFORM;POSITION;PURGE;QUOTES;AA;BB;RAISE;READ;RECEIVE;RELEASE;RESUME;RETURN;REWRITE;SEARCH;SELF;SEND;SET;SORT;SPACES;START;STOP;STRING;SUBTRACT;SUPER;SUPPRESS;TERMINATE;TRANSFORM;UNLOCK;UNSTRING;UPON;VALIDATE;WITH;WITH NO ADVANCING;WRITE;ZEROS]
    ...
    ----                  ^
      ...
      12               ON SIZE ERROR
    (line 9, character 15):
    List of completions (18 entries): [ADDRESS;ALL;CORRESPONDING;EXCEPTION-OBJECT;FUNCTION;HIGH-VALUES;LINAGE-COUNTER;LINE-COUNTER;LOW-VALUES;NULL;PAGE-COUNTER;QUOTES;AA;BB;SELF;SPACES;SUPER;ZEROS]
    ...
    ----                     ^
      ...
      12               ON SIZE ERROR
    (line 9, character 18):
    List of completions (4 entries): [AS;IN;OF;TO]
    ...
    ----                        ^
      ...
      12               ON SIZE ERROR
    (line 9, character 21):
    List of completions (11 entries): [ADDRESS;EXCEPTION-OBJECT;FUNCTION;LINAGE-COUNTER;LINE-COUNTER;NULL;PAGE-COUNTER;AA;BB;SELF;SUPER]
    ...
    List of completions (4 entries): [AS;BY;IN;OF]
    ...
    List of completions (71 entries): [ACCEPT;ADD;ADDRESS;ALLOCATE;ALTER;CALL;CANCEL;CLOSE;COMPUTE;CONTINUE;DELETE;DISABLE;DISPLAY;DIVIDE;ENABLE;END-MULTIPLY;ENTER;ENTRY;EVALUATE;EXCEPTION-OBJECT;EXIT;FREE;FUNCTION;GENERATE;GO;GOBACK;IF;INITIALIZE;INITIATE;INSPECT;INVOKE;LINAGE-COUNTER;LINE-COUNTER;MERGE;MODE;MOVE;MULTIPLY;NEXT SENTENCE;NOT ON SIZE ERROR;NULL;ON SIZE ERROR;OPEN;PAGE-COUNTER;PERFORM;PURGE;AA;BB;RAISE;READ;RECEIVE;RELEASE;RESUME;RETURN;REWRITE;SEARCH;SELF;SEND;SET;SORT;START;STOP;STRING;SUBTRACT;SUPER;SUPPRESS;TERMINATE;TRANSFORM;UNLOCK;UNSTRING;VALIDATE;WRITE]
    ...
    List of completions (70 entries): [ACCEPT;ADD;ADDRESS;ALLOCATE;ALTER;CALL;CANCEL;CLOSE;COMPUTE;CONTINUE;DELETE;DISABLE;DISPLAY;DIVIDE;ENABLE;END-MULTIPLY;ENTER;ENTRY;EVALUATE;EXCEPTION-OBJECT;EXIT;FREE;FUNCTION;GENERATE;GO;GOBACK;IF;INITIALIZE;INITIATE;INSPECT;INVOKE;LINAGE-COUNTER;LINE-COUNTER;MERGE;MOVE;MULTIPLY;NEXT SENTENCE;NOT ON SIZE ERROR;NULL;ON SIZE ERROR;OPEN;PAGE-COUNTER;PERFORM;PURGE;AA;BB;RAISE;READ;RECEIVE;RELEASE;RESUME;RETURN;REWRITE;SEARCH;SELF;SEND;SET;SORT;START;STOP;STRING;SUBTRACT;SUPER;SUPPRESS;TERMINATE;TRANSFORM;UNLOCK;UNSTRING;VALIDATE;WRITE]
    ...
    List of completions (88 entries): [ACCEPT;ADD;ADDRESS;ALL;ALLOCATE;ALTER;AT;CALL;CANCEL;CLOSE;COL;COLUMN;COMPUTE;CONTINUE;DELETE;DISABLE;DISPLAY;DIVIDE;ENABLE;END-DISPLAY;END-MULTIPLY;ENTER;ENTRY;EVALUATE;EXCEPTION;EXCEPTION-OBJECT;EXIT;FREE;FUNCTION;GENERATE;GO;GOBACK;HIGH-VALUES;IF;INITIALIZE;INITIATE;INSPECT;INVOKE;LINAGE-COUNTER;LINE;LINE-COUNTER;LOW-VALUES;MERGE;MODE;MOVE;MULTIPLY;NEXT SENTENCE;NOT ON EXCEPTION;NOT ON SIZE ERROR;NULL;ON EXCEPTION;OPEN;PAGE-COUNTER;PERFORM;POSITION;PURGE;QUOTES;AA;BB;RAISE;READ;RECEIVE;RELEASE;RESUME;RETURN;REWRITE;SEARCH;SELF;SEND;SET;SORT;SPACES;START;STOP;STRING;SUBTRACT;SUPER;SUPPRESS;TERMINATE;TRANSFORM;UNLOCK;UNSTRING;UPON;VALIDATE;WITH;WITH NO ADVANCING;WRITE;ZEROS] |}]
...
let%expect_test "control-completion" =
  ...
  [%expect {|
    ...
    (line 3, character 10):
    List of completions (7 entries): [ACCEPT;CLASS-ID;FUNCTION-ID;ID;IDENTIFICATION;INTERFACE-ID;PROGRAM-ID]
