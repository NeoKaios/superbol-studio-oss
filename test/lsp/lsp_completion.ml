...
let%expect_test "division-and-section-completion" =
  ...
  [%expect {|
    ...
    (line 3, character 8):
    List of completions (29 entries): [AUTHOR;COMMUNICATION;CONFIGURATION;DATA;DATE-COMPILED;DATE-MODIFIED;DATE-WRITTEN;END;ENVIRONMENT;FD;FILE;FILE-CONTROL;ID;IDENTIFICATION;INPUT-OUTPUT;INSTALLATION;I-O-CONTROL;LINKAGE;LOCAL-STORAGE;OPTIONS;PROCEDURE;PROGRAM-ID;REMARKS;REPORT;SCREEN;SD;SECURITY;SELECT;WORKING-STORAGE]
...
let%expect_test "datadiv-completion" =
  ...
  [%expect {|
    ...
    ----                                  ^
      ...
      10             DISPLAY DATA-NAME.
    (line 7, character 31):
    List of completions (12 entries): [ALL;FALSE;HIGH-VALUES;IN;LOW-VALUES;QUOTES;SET;SPACES;THRU;TO;WHEN;ZEROS] |}]
...
let%expect_test "control-completion" =
  ...
  [%expect {|
    ...
    (line 3, character 10):
    List of completions (8 entries): [ACCEPT;CLASS-ID;DISPLAY;FUNCTION-ID;ID;IDENTIFICATION;INTERFACE-ID;PROGRAM-ID]
