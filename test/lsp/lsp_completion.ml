...
let%expect_test "basic-completion" =
  ...
  [%expect {|
    ...
    ----              ^
       ...
       8             DISPLAY DATA-NAME
    (line 5, character 11):
    List of completions: [VARYING;VALUES;VALUE;VAL-STATUS;USAGE;TYPEDEF;TYPE;TRAILING;SYNCHRONIZED;SIGN;SELECT;SAME;REDEFINES;PROPERTY;PROGRAM-POINTER;PROCEDURE-POINTER;PRESENT;POINTER;PICTURE;PACKED-DECIMAL;OCCURS;OBJECT;NATIONAL;LEADING;JUSTIFIED;INVALID;INDEX;GROUP-USAGE;GLOBAL;FUNCTION-POINTER;FLOAT-SHORT;FLOAT-LONG;FLOAT-EXTENDED;FLOAT-DECIMAL-34;FLOAT-DECIMAL-16;FLOAT-BINARY-64;FLOAT-BINARY-32;FLOAT-BINARY-128;FILLER;EXTERNAL;DYNAMIC;DISPLAY;DESTINATION;DEFAULT;COMP-X;COMP-N;COMP-9;COMP-6;COMP-5;COMP-4;COMP-3;COMP-2;COMP-15;COMP-10;COMP-1;COMP-0;COMP;CLASS;BLANK;BIT;BINARY-SHORT;BINARY-LONG;BINARY-DOUBLE;BINARY-C-LONG;BINARY-CHAR;BINARY;BASED;ANY;ALIGNED]
    ...
    ----             ^
      ...
      10
    (line 7, character 10):
    List of completions: [WRITE;VALIDATE;UNSTRING;UNLOCK;TRANSFORM;TERMINATE;SUPPRESS;SUBTRACT;STRING;STOP;START;SORT;SET;SEND;SEARCH;REWRITE;RETURN;RESUME;RELEASE;RECEIVE;READ;RAISE;PURGE;PROGRAM-ID;PERFORM;OPEN;MULTIPLY;MOVE;MERGE;INVOKE;INSPECT;INITIATE;INITIALIZE;IF;IDENTIFICATION;ID;GOBACK;GO;GENERATE;FREE;EXIT;EVALUATE;ENTRY;ENTER;END;ENABLE;DIVIDE;DISPLAY;DISABLE;DELETE;DECLARATIVES;CONTINUE;COMPUTE;CLOSE;CANCEL;CALL;ALTER;ALLOCATE;ADD;ACCEPT]
    ...
    ----                  ^
      10
    (line 8, character 15):
    List of completions: [DATA-NAME;ZEROS;WRITE;WHEN;VALIDATE;UNSTRING;UNLOCK;TRANSFORM;THREAD;TERMINATE;SUPPRESS;SUBTRACT;STRING;STOP;START;SPACES;SORT;SET;SEND;SEARCH;RUN;REWRITE;RETURN;RESUME;RELEASE;RECEIVE;READ;RAISE;QUOTES;PURGE;PERFORM;OVERFLOW;OPEN;MULTIPLY;MOVE;MERGE;LOW-VALUES;INVOKE;INSPECT;INITIATE;INITIALIZE;IF;HIGH-VALUES;GOBACK;GO;GENERATE;FREE;EXIT;EXCEPTION;EVALUATE;ERROR;EOP;ENTRY;ENTER;END-WRITE;END-UNSTRING;END-SUBTRACT;END-STRING;END-START;END-SEARCH;END-REWRITE;END-RETURN;END-RECEIVE;END-READ;END-PERFORM;END-OF-PAGE;END-MULTIPLY;END-IF;END-EVALUATE;END-DIVIDE;END-DISPLAY;END-DELETE;END-COMPUTE;END-CALL;END-ADD;END-ACCEPT;END;ENABLE;ELSE;DIVIDE;DISPLAY;DISABLE;DELETE;DATA;CONTINUE;COMPUTE;CLOSE;CANCEL;CALL;ALTER;ALLOCATE;ALL;ADD;ACCEPT]
...
let%expect_test "datadiv-completion" =
  ...
  [%expect {|
    ...
    ----                            ^
       ...
       9             DISPLAY DATA-NAME.
    (line 6, character 25):
    List of completions: [ZERO-FILL;VARYING;VALUES;VALUE;VAL-STATUS;USING;USAGE;UNDERLINE;TYPEDEF;TYPE;TRAILING;TO;SYNCHRONIZED;SUM;SOURCES;SOURCE;SIZE;SIGN;SELECT;SECURE;SAME;REVERSE-VIDEO;REQUIRED;REDEFINES;PROPERTY;PROMPT;PROGRAM-POINTER;PROCEDURE-POINTER;PRESENT;POINTER;PICTURE;PACKED-DECIMAL;OVERLINE;OCCURS;OBJECT;NO-ECHO;NEXT;NATIONAL;LOWLIGHT;LOCALE;LINES;LINE;LEFTLINE;LEADING;JUSTIFIED;INVALID;INDEX;HIGHLIGHT;GROUP-USAGE;GROUP;GRID;GLOBAL;FUNCTION-POINTER;FULL;FROM;FOREGROUND-COLOR;FLOAT-SHORT;FLOAT-LONG;FLOAT-EXTENDED;FLOAT-DECIMAL-34;FLOAT-DECIMAL-16;FLOAT-BINARY-64;FLOAT-BINARY-32;FLOAT-BINARY-128;EXTERNAL;ERASE;DYNAMIC;DISPLAY;DESTINATION;DEPENDING;DEFAULT;CONTROL;COMP-X;COMP-N;COMP-9;COMP-6;COMP-5;COMP-4;COMP-3;COMP-2;COMP-15;COMP-10;COMP-1;COMP-0;COMP;COLS;COLUMN;COL;CLASS;BLINK;BLANK;BIT;BINARY-SHORT;BINARY-LONG;BINARY-DOUBLE;BINARY-C-LONG;BINARY-CHAR;BINARY;BELL;BASED;BACKGROUND-COLOR;AUTO;ANY;ALIGNED]
