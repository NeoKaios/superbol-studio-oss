...
let%expect_test "division-and-section-completion" =
  ...
  [%expect {|
    ...
    (line 3, character 8):
    List of completions (29 entries): [AUTHOR;COMMUNICATION;CONFIGURATION;DATA;DATE-COMPILED;DATE-MODIFIED;DATE-WRITTEN;END PROGRAM;ENVIRONMENT;FD;FILE;FILE-CONTROL;ID;IDENTIFICATION;INPUT-OUTPUT;INSTALLATION;I-O-CONTROL;LINKAGE;LOCAL-STORAGE;OPTIONS;PROCEDURE;PROGRAM-ID;REMARKS;REPORT;SCREEN;SD;SECURITY;SELECT;WORKING-STORAGE]
    ...
    (line 4, character 8):
    List of completions (15 entries): [COMMUNICATION;DATA;END PROGRAM;FD;FILE;ID;IDENTIFICATION;LINKAGE;LOCAL-STORAGE;PROCEDURE;PROGRAM-ID;REPORT;SCREEN;SD;WORKING-STORAGE]
    ...
    ----           ^
       ...
       9             STOP RUN.
    (line 6, character 8):
    List of completions (11 entries): [COMMUNICATION;END PROGRAM;ID;IDENTIFICATION;LINKAGE;LOCAL-STORAGE;PROCEDURE;PROGRAM-ID;REPORT;SCREEN;WORKING-STORAGE]
...
let%expect_test "procedure-paragraph-completion" =
  ...
  [%expect {|
    ...
    ----               ^
      ...
      12               DISPLAY VAR.
    (line 9, character 12):
    List of completions (61 entries): [.;ACCEPT;ADD;ALLOCATE;ALTER;CALL;CANCEL;CLOSE;COMPUTE;CONTINUE;DELETE;DISABLE;DISPLAY;DIVIDE;ENABLE;END PROGRAM;ENTER;ENTRY;EVALUATE;EXIT;FREE;GENERATE;GO;GOBACK;ID;IDENTIFICATION;IF;INITIALIZE;INITIATE;INSPECT;INVOKE;MERGE;MOVE;MULTIPLY;NEXT SENTENCE;OPEN;PERFORM;PROGRAM-ID;PURGE;RAISE;READ;RECEIVE;RELEASE;RESUME;RETURN;REWRITE;SEARCH;SEND;SET;SORT;START;STOP;STRING;SUBTRACT;SUPPRESS;TERMINATE;TRANSFORM;UNLOCK;UNSTRING;VALIDATE;WRITE]
...
let%expect_test "procedure-completion" =
  ...
  [%expect {|
    ...
    ----                     ^
      ...
      12               ON SIZE ERROR
    (line 9, character 18):
    List of completions (7 entries): [AS;AS UNIVERSAL;AS FACTORY OF;IN;OF;OF SUPER;TO]
    ...
    List of completions (7 entries): [AS;AS UNIVERSAL;AS FACTORY OF;BY;IN;OF;OF SUPER]
    ...
    List of completions (79 entries): [.;ACCEPT;ADD;ADDRESS;ALLOCATE;ALTER;AS;AS UNIVERSAL;AS FACTORY OF;CALL;CANCEL;CLOSE;COMPUTE;CONTINUE;DELETE;DISABLE;DISPLAY;DIVIDE;ENABLE;END-MULTIPLY;ENTER;ENTRY;EVALUATE;EXCEPTION-OBJECT;EXIT;FREE;FUNCTION;GENERATE;GIVING;GO;GOBACK;IF;IN;INITIALIZE;INITIATE;INSPECT;INVOKE;LINAGE-COUNTER;LINE-COUNTER;MERGE;MOVE;MULTIPLY;NEXT SENTENCE;NOT ON SIZE ERROR;NULL;OF;OF SUPER;ON SIZE ERROR;OPEN;PAGE-COUNTER;PERFORM;PURGE;AA;BB;RAISE;READ;RECEIVE;RELEASE;RESUME;RETURN;REWRITE;ROUNDED;SEARCH;SELF;SEND;SET;SORT;START;STOP;STRING;SUBTRACT;SUPER;SUPPRESS;TERMINATE;TRANSFORM;UNLOCK;UNSTRING;VALIDATE;WRITE]
    ...
    List of completions (72 entries): [.;ACCEPT;ADD;ADDRESS;ALLOCATE;ALTER;CALL;CANCEL;CLOSE;COMPUTE;CONTINUE;DELETE;DISABLE;DISPLAY;DIVIDE;ENABLE;END-MULTIPLY;ENTER;ENTRY;EVALUATE;EXCEPTION-OBJECT;EXIT;FREE;FUNCTION;GENERATE;GO;GOBACK;IF;INITIALIZE;INITIATE;INSPECT;INVOKE;LINAGE-COUNTER;LINE-COUNTER;MERGE;MODE;MOVE;MULTIPLY;NEXT SENTENCE;NOT ON SIZE ERROR;NULL;ON SIZE ERROR;OPEN;PAGE-COUNTER;PERFORM;PURGE;AA;BB;RAISE;READ;RECEIVE;RELEASE;RESUME;RETURN;REWRITE;SEARCH;SELF;SEND;SET;SORT;START;STOP;STRING;SUBTRACT;SUPER;SUPPRESS;TERMINATE;TRANSFORM;UNLOCK;UNSTRING;VALIDATE;WRITE]
